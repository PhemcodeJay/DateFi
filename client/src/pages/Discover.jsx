        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="relative h-96 bg-gradient-to-br from-pink-400 to-purple-600">
            {currentProfile.photos && currentProfile.photos.length > 0 ? (
              <img
                src={`http://localhost:5000${currentProfile.photos[0]}`}
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
              ...
              {currentProfile.bio && (
                <p className="text-white/90 mt-2 line-clamp-2">{currentProfile.bio}</p>
              )}
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="flex justify-center gap-6 mt-8">
              <button
                onClick={handlePass}
                className="w-16 h-16 bg-gray-200 hover:bg-gray-300 rounded-full flex items-center justify-center text-3xl transition-all transform hover:scale-110 shadow-lg"
              >
                ✕
              </button>
              <button
                onClick={handleLike}
                className="w-16 h-16 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 rounded-full flex items-center justify-center text-3xl text-white transition-all transform hover:scale-110 shadow-lg"
              >
                ♥
              </button>
            </div>
